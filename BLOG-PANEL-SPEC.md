...
- یک اسکریپت دیف نرمالایزشده (whitespace-insensitive) بنویس که خروجی `_site/*.html` را با نسخهٔ فعلی مقایسه کند. **اختلاف معنادار باید صفر باشد.**
- هر پنج صفحه با همان آدرس قبلی باز می‌شوند
- سه تم (albatross / rose / mono)، دکمهٔ dark/light و منوی موبایل روی خروجی جدید کار می‌کنند
